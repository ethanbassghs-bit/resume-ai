...
def format_resume(text_sections):
    ...
    # Set page size to Letter and margins to Apollo format
    ...
    # Contact Info in two columns using table
    ...
    for section_title, content in text_sections.items():
        doc.add_paragraph("\n")  # Extra line for spacing between sections
...
if raw_text:
    ...
    if st.button("📁 Format into Resume Template"):
        # Simplified parsing: user must use headers like EDUCATION, EXPERIENCE, etc.
        sections = {}
