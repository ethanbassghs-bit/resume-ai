...
def format_resume(text_sections):
    ...
    # Contact info (2-row, 3-col table)
    table = doc.add_table(rows=2, cols=3)
    table.autofit = False
    widths = [Inches(2.5), Inches(3), Inches(2.5)]
    for i, width in enumerate(widths):
        table.columns[i].width = width

    # Row 1
    row1 = table.rows[0].cells
    row1[0].paragraphs[0].add_run("1091 McLynn Avenue").font.name = "Garamond"
    row1[1].paragraphs[0].add_run("(404) 435-1520 | ethanbassghs@gmail.com").font.name = "Garamond"
    row1[2].paragraphs[0].add_run("170 River Road").font.name = "Garamond"

    # Row 2
    row2 = table.rows[1].cells
    row2[0].paragraphs[0].add_run("Atlanta, GA 30306").font.name = "Garamond"
    row2[2].paragraphs[0].add_run("Athens, GA 30605").font.name = "Garamond"
    ...
    doc.add_paragraph("")  # space after contact
    ...
    for section_title, content in text_sections.items():
        ...
        while i < len(sorted_content):
            ...
            if line and line[0].isupper() and "," in line and len(line.split()) < 20:
                ...
                job_para.paragraph_format.line_spacing = 1
                ...
                for bp in bullet_points:
                    ...
                    bullet.paragraph_format.line_spacing = 1
